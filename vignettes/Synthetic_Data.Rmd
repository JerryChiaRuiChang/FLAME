...
2. Get conditional average treatment effect (CATE)
...
c. To see the all matched groups where (x2 = 1, x3 = 0, x5 = 1), apply `CATE` function as below. Note that (x2 = 1, x3 = 0, x5 = 1) is represented by input cov_name = c("x2", "x3", "x5") and cov_val = c(1, 0, 1).
