...
b. To see the CATE for (x1 = 1, x2 = 1, x3 = 0,...) when exactly $n$ covariates are used for matching, apply `CATE` function as below. Note that (x1 = 1, x2 = 1, x3 = 0, ...) is represented by input cov_name = c("x1", x2", "x3", ...) and cov_val = c(1, 1, 0, ...).
...
c. To see the all matched groups where the unit contains the covariate combination (x2 = 1, x3 = 0, x5 = 1), apply `CATE` function as below. Note that (x2 = 1, x3 = 0, x5 = 1) is represented by input cov_name = c("x2", "x3", "x5") and cov_val = c(1, 0, 1).
