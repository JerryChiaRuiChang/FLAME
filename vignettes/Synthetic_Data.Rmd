...
\end{aligned}
$$
$T \in \{0,1\}$ indicates whether an unit is treated or in control. $U$ represents the number of unimportant covariates. $\alpha_{i} \sim N(10s, 1)$ with $s \sim Uniform\{-1,1\}$, $\beta_{i} \sim N(1.5,0.15)$.   
...
All three implementation yields the same results.
