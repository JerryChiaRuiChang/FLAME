...
This vignette demonstrates how to get detailed information such as conditional average treatment effect (CATE), variance, and average treatment effect (ATE) from the `FLAME` package after matching.
